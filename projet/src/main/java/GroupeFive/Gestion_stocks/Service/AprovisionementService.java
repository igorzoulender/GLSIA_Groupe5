...
public class AprovisionementService {
    @Autowired
    private AprovisionementRepo aprovisionementRepo;
    @Autowired
    ...
    public void Faireaprovisionement(Aprovisionement aprovisionement){
        ...
        articleRepo.updateStockArticle(aprovisionement.getQuantite(), aprovisionement.getArticleId());
    }
    ...
    public void deleteApprovisionnement(int id){
        ...
        Aprovisionement aprovisionement = FindAprovisionementById(id);
        articleRepo.updateStockArticle(-1*aprovisionement.getQuantite(), aprovisionement.getArticleId());
